...
// Same canonical sample-answer carousel as /captainkarynn and
// /womenoffshore. Three pages, one demo — no fragmentation.
const SAMPLE_ANSWERS: Array<{ sourceTag: string; question: string; answer: string }> = [
  {
  ...
  {
    sourceTag: 'IMDG Ch.7.2',
    question: 'I have UN1830 sulfuric acid in one container and UN1873 perchloric acid in another. How do I have to segregate them on a containership?',
    answer: 'Both are Class 8 corrosives, but they’re in different segregation groups. Per {citation: IMDG 7.2}, the Class 8 segregation table requires "separated from" between strong acids and oxidizing perchlorates — minimum one-container separation horizontally, one-deck separation vertically. Check the segregation group codes on each entry in the {citation: IMDG 3.2} Dangerous Goods List for the specific exemptions.',
  },
  {
    ...
    <section className="px-5 pb-20 bg-[#0a0e1a]">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="font-mono text-sm text-[#6b7594] text-center mb-8 max-w-md mx-auto">
          Every answer references the specific regulation paragraph it came from. Verify before you act.
        </p>
