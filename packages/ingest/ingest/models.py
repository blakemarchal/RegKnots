...
PDF_SOURCES: list[str] = ["amsa_mo", "bma_mn", "colregs", "erg", "iacs_ur", "imdg", "imdg_manual", "imdg_supplement", "imo_bwm", "imo_css", "imo_hsc", "imo_iamsar", "imo_ibc", "imo_igc", "imo_igf", "imo_loadlines", "imo_polar", "iri_mn", "ism", "ism_supplement", "liscr_mn", "mardep_msin", "marpol", "marpol_supplement", "mca_mgn", "mca_msn", "mou_psc", "mpa_sc", "nma_rsv", "nmc_checklist", "nmc_policy", "nvic", "solas", "solas_supplement", "stcw", "stcw_supplement", "tc_ssb", "usc_46", "uscg_bulletin", "uscg_msm", "who_ihr"]
