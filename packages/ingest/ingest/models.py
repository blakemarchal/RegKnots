...
PDF_SOURCES: list[str] = ["colregs", "erg", "ism", "ism_supplement", "marpol", "marpol_supplement", "nmc_checklist", "nmc_policy", "nvic", "solas", "solas_supplement", "stcw", "stcw_supplement", "usc_46", "uscg_bulletin", "uscg_msm", "who_ihr"]
